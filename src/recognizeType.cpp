...
{
	return DataType::INT8_T_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::UINT8_T_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::INT16_T_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::INT32_T_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::UINT32_T_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::FLOAT_RET_FUNC;
	variable = variable;
}

DataType recognizeType(doubleFnPtr variable)
{
	return DataType::DOUBLE_RET_FUNC;
	variable = variable;
}

DataType recognizeType(charFnPtr variable)
{
	return DataType::CHAR_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::CHAR_PTR_RET_FUNC;
	variable = variable;
}
...
{
	return DataType::CONST_CHAR_PTR_RET_FUNC;
	variable = variable;
}
